...
@app.route('/get/')
def get():
# обращаемся к объекту request, к его свойству args, который получает
# доступ к объекту кортеж, а именно к неизменяемому словарю
...
# f'{request.args}' - для вывода словаря

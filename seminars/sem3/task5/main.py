...
from task5.forms import RegisterForm

from flask_sqlalchemy import SQLAlchemy
from task5.model import db, User

app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///users_hw5.db'
db.init_app(app)
...
def registration():
    ...
    if request.method == 'POST' and form.validate():
        ...
        db.session.add(user)
        db.session.commit()
        print(name, email, password, birthdate)
